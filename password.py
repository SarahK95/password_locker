...
class Credentials:
    ...
    def password_exist(cls,password):
        ...
        Method that checks if a user exists from the user list.username. user name to search if it exists.Boolean: True or false depending if the contact exists
        """
